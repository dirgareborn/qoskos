        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="card-img-overlay overflow-hidden overlay-danger overlay-lighten-2">
              ...
              <p class="card-text"><small class="text-white">Posted by Qos Kos</small></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="card-img-overlay overflow-hidden overlay-warning overlay-lighten-2">
              <h4 class="card-title text-white">Ingat Kamar Ingat Qos Kos.</h4>
              <p class="card-text text-white">Cari kamar terbaik dengan ratusan tempat di seluruh Indonesia di Qos Kos.
              </p>
              <p class="card-text"><small class="text-white">Posted by Qos Kos</small></p>
            </div>
          </div>
