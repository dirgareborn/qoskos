              ...
              <div class="form-body ">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                      ...
                      <select name="village_id" class="form-control select2  @error('village_id') is-invalid @enderror" id="village"></select>
                      @error('village_id')
                        <div class="invalid-feedback">
                          <strong>{{ $message }}</strong>
                        </div>
                ...
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label class="col-form-label">Tata Tertib Kos</label>
...
@section('scripts')
  ...
  $('#province').change(function(){
    ...
    if(districtID){
      $.ajax({
        type:"GET",
        url:"{{url('select-village')}}?district_id="+districtID,
        success:function(res){
        if(res){
          $("#village").empty();
