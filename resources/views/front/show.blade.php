...
@section('title')
  {{$kamar->nama_kamar}} {{ucfirst(strtolower($kamar->district->name))}}
@endsection
@section('content')
...
<div class="row">
  <div class="col-12">
    <h4 class="card-title">
      ...
      <a href="" style="font-size: 15px;">Kecamatan {{ucwords(strtolower($kamar->district->name))}}  ></a>
      <a href="" style="font-size: 15px;">Kelurahan {{ucwords(strtolower($kamar->village->name))}}  ></a>
  ...
  <div class="col-lg-12 col-xl-4">
    <div class="card">
      <div class="card-content">
        <div class="card-body ">
          <img src="{{ asset('storage/images/foto_profile/'. $kamar->user->foto) }}" width="50px" height="50px" class="rounded">
          ...
          <a class="btn btn-outline-black" target="_blank" href="http://wa.me/{{$kamar->user->no_wa}}">Kirim pesan ke pemilik kos</a>
          <hr>
  ...
  <div class="col-lg-8">
    ...
    <div class="card">
      <div class="card-body">
        <h3>{{$kamar->nama_kamar}} {{ucwords(strtolower($kamar->village->name))}} </h3>
        ...
        <small style="text-decoration:underline"> {{ucfirst(strtolower($kamar->village->name))}}, {{ucfirst(strtolower($kamar->district->name))}}, {{ucfirst(strtolower($kamar->regencies->name))}}, {{ucfirst(strtolower($kamar->provinsi->name))}} </small>
        <hr>
          <h3 style="font-weight: bold">Reviews</h3> <br>
            @foreach ($kamar->reviews as $review)
              <div class="mb-3">
                <img src="{{ asset('storage/images/foto_profile/'. $kamar->user->foto) }}" width="40px" height="40px" class="rounded">
    ...
    <div class="card">
      <div class="card-body" id="tampil">
        ...
        <ul>
          ...
          <li style="font-size: 12px"><span style="color:black">Biaya Admin</span> adalah biaya pelayanan yang di bebankan penyewa untuk Qos Kos.</li>
