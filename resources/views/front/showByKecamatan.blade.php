...
@section('content')
  ...
  <div class="mb-2" style="font-weight: bold">
    @if ($kecamatan == 'Biringkanaya')
      Kost di Kecamatan Biringkanaya
    @elseif($kecamatan == 'Bontoala')
      Kost di Kecamatan Bontoala
    @elseif($kecamatan == 'Rappocini')
      Kost di Kecamatan Rappocini
    @elseif($kecamatan == 'Tamalate')
      Kost di Kecamatan Tamalate
    @elseif($kecamatan == 'Mamajang')
      Kost di Kecamatan Mamajang
    @elseif($kecamatan == 'Mariso')
      Kost di Kecamatan Mariso
    @elseif($kecamatan == 'Manggala')
      Kost di Kecamatan Manggala
    @else
        ...
        <div class="card-content">
          ...
          <div class="card-body">
            <a href="{{url('room', $kamars->slug)}}">
              ...
              <p class="card-text mt-1 mb-0"><i class="feather icon-map-pin"></i> {{ucfirst(strtoupper($kamars->district->name))}}</p>
