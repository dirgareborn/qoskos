<nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-fixed">
            ...
            <a class="navbar-brand d-xl-none" href="#">
                ...
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="mr-2 d-none d-xl-block">
                          <a href="{{ route('download.apk') }}" style="color: black" ><i class="feather icon-airplay" data-toggle="tooltip" data-placement="bottom" title="Download App"></i> Download App</a>
                        </li>
                        <li class="d-none d-xl-block">
                          <a href="{{url('show-all-room')}}" style="color: black"><i class="feather icon-calendar" data-toggle="tooltip" data-placement="top" title="Booking Kos"></i> Booking Kos</a>
                        </li>
                    </ul>
                </div>
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-notification nav-item">
                                ...
                                <div class="media d-flex align-items-start">
                                  <div class="media-left">{{$key+1}}</div>
                                    <div class="media-body">
                                      <h6 class="warning media-heading">{{$favorite->kamar['nama_kamar']}}</h6>
                     ...
                     <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-warning badge-up">0</span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
